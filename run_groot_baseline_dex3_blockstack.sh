...
#SBATCH --qos=gtqos
#SBATCH --mem=512G
#SBATCH --job-name=groot_base_dex3_bs
#SBATCH --output=/vast/users/chenyuan.chen/constantine/unitree_IL_lerobot/unitree_lerobot/lerobot/slurm_groot_base_dex3_bs_%j.log
#SBATCH --error=/vast/users/chenyuan.chen/constantine/unitree_IL_lerobot/unitree_lerobot/lerobot/slurm_groot_base_dex3_bs_%j.log
...
echo "=========================================="
echo "BASELINE: original GR00T + LoRA, Dex3 BlockStacking"
...
OUTPUT_DIR=outputs/train/$(date +%Y%m%d_%H%M%S)_groot_baseline_dex3_blockstack_lora
...
accelerate launch \
  ...
  --dataset.dex3_dataset=blockstacking \
  ...
  --wandb.notes="Baseline: original GR00T + LoRA r=16 on Dex3 BlockStacking (real robot)"
