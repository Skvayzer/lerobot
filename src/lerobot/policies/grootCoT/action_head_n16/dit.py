"""Diffusion Transformer modules for N1.6 action head.

Ported from Isaac-GR00T gr00t/model/modules/dit.py.
Contains: TimestepEncoder, AdaLayerNorm, BasicTransformerBlock, DiT,
...
class AlternateVLDiT(DiT):
    ...
    def forward(
        ...
        # Ensure bool dtype for SDPA compatibility
