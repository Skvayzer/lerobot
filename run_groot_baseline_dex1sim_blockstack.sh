...
#SBATCH --qos=gtqos
#SBATCH --mem=512G
#SBATCH --job-name=groot_base_dex1sim_bs
#SBATCH --output=/vast/users/chenyuan.chen/constantine/unitree_IL_lerobot/unitree_lerobot/lerobot/slurm_groot_base_dex1sim_bs_%j.log
#SBATCH --error=/vast/users/chenyuan.chen/constantine/unitree_IL_lerobot/unitree_lerobot/lerobot/slurm_groot_base_dex1sim_bs_%j.log
...
echo "=========================================="
echo "BASELINE: original GR00T + LoRA, Dex1 Sim BlockStacking"
...
OUTPUT_DIR=outputs/train/$(date +%Y%m%d_%H%M%S)_groot_baseline_dex1sim_blockstack_lora
...
accelerate launch \
  ...
  --wandb.notes="Baseline: original GR00T + LoRA r=16 on Dex1 Sim BlockStacking (simulated)"
